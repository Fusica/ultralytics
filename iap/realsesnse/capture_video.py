...
if __name__ == '__main__':
    ...
    # 视频保存路径
    os.mkdir(f'/Users/max/Downloads/Realsense/{int(time.time())}')
    video_path = f'/Users/max/Downloads/Realsense/{int(time.time())}//targetvideo_rgb.mp4'
    video_depthc_path = f'/Users/max/Downloads/Realsense/{int(time.time())}//targetvideo_depthcolor.mp4'
    video_depth16_path = f'/Users/max/Downloads/Realsense/{int(time.time())}//targetvideo_depth.h5'
